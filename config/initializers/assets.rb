...
Rails.application.config.assets.precompile += %w( node_modules/font-awesome/css/font-awesome.min.css )
Rails.application.config.assets.precompile += %w( node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css )
Rails.application.config.assets.precompile += %w( node_modules/flag-icon-css/css/flag-icon.min.css )
Rails.application.config.assets.precompile += %w( css/admin-style.css )
Rails.application.config.assets.precompile += %w( images/favicon.png )

Rails.application.config.assets.precompile += %w( node_modules/popper.js/dist/umd/popper.min.js )
Rails.application.config.assets.precompile += %w( node_modules/chart.js/dist/Chart.min.js )
Rails.application.config.assets.precompile += %w( node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js )
Rails.application.config.assets.precompile += %w( js/off-canvas.js )
Rails.application.config.assets.precompile += %w( js/hoverable-collapse.js )
Rails.application.config.assets.precompile += %w( js/misc.js )
Rails.application.config.assets.precompile += %w( js/chart.js )
Rails.application.config.assets.precompile += %w( js/maps.js )
